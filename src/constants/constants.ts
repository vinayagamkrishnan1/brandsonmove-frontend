...
export const CONSUMERBRANDANDINSIGHTS = [
    {
        id: 0,
        name: "Attributes driving",
        description: "Brand Relevance, Distinction and Salience",
        title: "We discover strength of causal relationship within a set of formative and reflective latent constructs to help identify direct and indirect relationships of attributes driving brand relevance, distinction and salience among consumers.",
    ...
    {
        id: 2,
        name: "Product Positioning & Feature Design",
        description: "imperatives for target Consumer Segment",
    ...
    },
    {
        ...
        description: "& profiling for retail banners and e-comm",
